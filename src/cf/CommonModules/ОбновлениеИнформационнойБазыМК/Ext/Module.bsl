...
//                                    выполняются последовательно в интервале
//                                    от номера версии информационной базы до номера
...
//                                      Допустимо указывать только для обработчиков
//                                      с режимом выполнения Монопольно и Оперативно.
...
//                                      которые следует блокировать от изменения
...
//                                      для остальных заполнение не требуется.
//                                      Имя функции, которая для переданного объекта 
...
//     * ЗапускатьТолькоВГлавномУзле  - Булево - только для обработчиков отложенного обновления
...
//     * ЧитаемыеОбъекты              - Строка - объекты, которые обработчик обновления будет читать
//                                      при обработке данных.
//     * ИзменяемыеОбъекты            - Строка - объекты, которые обработчик обновления будет изменять
//                                      при обработке данных.
//     * ПриоритетыВыполнения         - ТаблицаЗначений - таблица приоритетов выполнения между
//                                      отложенными обработчиками,
